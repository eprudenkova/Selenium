...
public class ExplicitWaitHandling {
    ...
    public static void main(String[] args) {
        ...
        WebDriverWait wait = new WebDriverWait(driver, 20);//creating webdriverwait obj and setting for 20 sec
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[contains(text(), 'First Name :')]")));//waiting untill
